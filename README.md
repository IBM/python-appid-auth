...
This code pattern requires
  * [IBM Cloud CLI](https://www.ibm.com/cloud/cli) with [IBM Cloud Code Engine plugin](https://cloud.ibm.com/docs/codeengine?topic=codeengine-install-cli) and [IBM Cloud Container Registry plugin](https://cloud.ibm.com/docs/Registry?topic=Registry-registry_setup_cli_namespace)
  * GitHub account
